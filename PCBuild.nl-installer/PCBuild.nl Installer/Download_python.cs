...
namespace PCBuild.nl_Installer
{
    public partial class Download_python : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DownloadFile("http://www.python.org/ftp/python/2.7.8/python-2.7.8.msi", @"C:\PCBuild.nl\Python.msi");
            DownloadScript("http://dl.dropboxusercontent.com/s/p7j0ehlwr4vzcaa/ez_setup.py", @"C:\PCBuild.nl\ez_setup.py");
        }
