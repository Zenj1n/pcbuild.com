    ...
    def parse_start_url(self, response):
        ...
        for titles in titles:
            ...
            query_CreatePriceRelationship = neo4j.CypherQuery(graph_db,
                                                          "MATCH (c:moederbord), (w:Webshop)  WHERE c.naam = {namedb} AND w.naam = {webshop} CREATE UNIQUE c-[:price]-w")
            ...
            query_CreateURLRelationship = neo4j.CypherQuery(graph_db,
                                                        "MATCH (c:moederbord), (w:Webshop)  WHERE c.naam = {namedb} AND w.naam = {webshop} CREATE UNIQUE c-[:url]-w")
